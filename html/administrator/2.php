		...
		<div id="nav">
			<div id="nav-bar">
				...
				<div class="info-change">
					<form action="../php/added.php" method="post">
						<h3>上架商品</h3>
						<div class="item">
							<span>商品编号:</span><input type="text" name="goodsId" />
						</div>
						<div class="item">
							<span>商品名称:</span><input type="text" name="goodsName" />
						</div>				
						<div class="item">
							<span>商品种类:</span><input type="text" name="classId" />
						</div>
						<div class="item">
							<span>图片名称:</span><input type="text" name="imageId" />
						</div>
                        <div class="item">
							<span>价格:</span><input type="text" name="price" />
						</div>
						<div class="item">
							<span>数量:</span><input type="text" name="amount" />
						</div>
						<div class="item">
							<span>商品描述:</span><input type="text" name="goodsIntroduce" />
						</div>
						<button class="btn-default btn-change">确认上架</button>
					</form>
				</div>
			</div>
